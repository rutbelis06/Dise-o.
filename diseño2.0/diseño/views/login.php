        ...
        <section class="login-section">
            ...
            <div class="form-container">
                    ...
                    <div style="background: #ff4444; color: white; padding: 10px; border-radius: 5px; margin-bottom: 15px; text-align: center; font-size: 13px; font-weight: bold; line-height: 1.4;">
                        <?php 
                            if ($_GET['error'] == 'invalid_credentials') {
                                ...
                                echo "ESTA CUENTA SE ENCUENTRA INACTIVA. POR FAVOR, CONTACTE AL ADMINISTRADOR.";
                            } else {
                ...
                <?php if (isset($_GET['success']) && $_GET['success'] == 'registered'): ?>
                    <div style="background: #2ecc71; color: white; padding: 10px; border-radius: 5px; margin-bottom: 15px; text-align: center; font-size: 13px; font-weight: bold; line-height: 1.4;">
                        ¡REGISTRO EXITOSO! YA PUEDES INICIAR SESIÓN CON TU CÉDULA.
                    </div>
                <?php endif; ?>
